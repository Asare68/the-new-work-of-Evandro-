...
raio_fim, void* s) {
 ...
 double x_intersect = (Ponto_get_x(raio_ini) +
Ponto_get_x(raio_fim)) / 2.0;
 double y_intersect = (Ponto_get_y(raio_ini) +
Ponto_get_y(raio_fim)) / 2.0;
 return Ponto_Criar(x_intersect, y_intersect);